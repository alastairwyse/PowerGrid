...
{
    /// <summary>
    /// DTO container class holding an item in the reponse to a <see cref="WeatherForecastPersisterHost.GetGridDetails(Grids.GridCommonKeyProperties)"/> method call.
    /// </summary>
    public class GetGridDetailsResponseItem : GetGridDetailsResponseItemBase
    {

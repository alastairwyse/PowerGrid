...
namespace PowerGrid.Grids.UnitTests
{
    ...
    public class WeatherForecastTests
    {
        ...
        public void Constructor_CountryParameterNull()
        {
            ...
            {
                WeatherForecast testWeatherForecast = new(null, "Tokyo", 25);
            });
        ...
        public void Constructor_CountryParameterWhitespace()
        {
            var e = Assert.Throws<ArgumentNullException>(delegate
            {
                WeatherForecast testWeatherForecast = new(" ", "Tokyo", 25);
            });
        ...
        public void Constructor_CityParameterNull()
        {
            var e = Assert.Throws<ArgumentNullException>(delegate
            {
                WeatherForecast testWeatherForecast = new("Japan", null, 25);
            });
        ...
        public void Constructor_CityParameterWhitespace()
        {
            var e = Assert.Throws<ArgumentNullException>(delegate
            {
                WeatherForecast testWeatherForecast = new("Japan", "", 25);
            });
        ...
        {
            WeatherForecast testWeatherForecast1 = new("Japan", "Tokyo", 25);
            WeatherForecast testWeatherForecast2 = new("Japan", "Tokyo", 25);
        ...
        public void ValuePropertiesEqual()
        {
            WeatherForecast testWeatherForecast1 = new("Japan", "Tokyo", 25);
            WeatherForecast testWeatherForecast2 = new("Japan", "Tokyo", 25);
            WeatherForecast testWeatherForecast3 = new("Japan", "Tokyo", 26);
